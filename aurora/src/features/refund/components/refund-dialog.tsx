    ...
    <Dialog open={props.open} onOpenChange={props.onOpenChange}>
      <DialogContent className='sm:max-w-lg'>
        <DialogHeader>
          ...
          <DialogDescription>
            {t(
              'Submit a refund request for your wallet balance. Manual review takes about 15 business days.'
            )}
          </DialogDescription>
        </DialogHeader>
  ...
  return (
    <div className='flex flex-col items-center gap-4 py-6 text-center'>
      ...
      <p className='text-muted-foreground max-w-sm text-sm leading-6'>
        {t(
          'Our team will review your request within 15 business days and reach out via your registered email.'
        )}
      </p>

...
export function Hero(props: HeroProps) {
  ...
  return (
    <section className='relative z-10 overflow-hidden px-6 pt-24 pb-16 md:pt-32 md:pb-24 lg:pt-36 lg:pb-28'>
      {/* Aurora radial glow background — mint green to match logo accent */}
      <div
        aria-hidden
        className='pointer-events-none absolute inset-0 -z-10'
        style={{
          background:
            'radial-gradient(60% 50% at 50% 0%, rgba(94, 241, 160, 0.22), transparent 70%),' +
            'radial-gradient(40% 40% at 80% 20%, rgba(12, 46, 38, 0.15), transparent 70%)',
        }}
      />
      {/* Grid pattern */}
      <div
          ...
          {props.isAuthenticated ? (
            <>
              <Button
                ...
                style={{ backgroundColor: '#0C2E26', color: '#F5FFFA' }}

...
const defaultBillingSettings: BillingSettings = {
  ...
  WonderGateEnabled: false,
  WonderGateSandbox: true,
  WonderGateMerchantId: '',
  WonderGateSecretKey: '',
  WonderGateAppId: '',
  WonderGateSandboxMerchantId: '',
  WonderGateSandboxSecretKey: '',
  WonderGateSandboxAppId: '',
  WonderGateUnitPrice: 1,
  WonderGateMinTopUp: 1,
  WonderGateBillingCountry: 'US',
  WonderGateCurrency: 'USD',
